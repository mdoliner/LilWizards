...
SpellList.ToxicDarts = function (spellIndex) {
...
var ToxicDartSpell = Spell.extend({
...
var ToxicDarkAilment = Ailment.extend({
  id: 'toxicDartEffect',
  duration: 240,
  tickEvent: function () {
...
var PurplePop = function () {
  ParticleSplatter(5, function () {
    var randVel = new Coord([1,0]).plusAngleDeg(Math.random() * 360);
    return {
      pos: this.pos,
      vel: randVel,
      game: this.game,
...
export default SpellList.ToxicDarts;
