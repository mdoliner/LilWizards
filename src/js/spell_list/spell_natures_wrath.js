...
var NaturesWrathSpell = Spell.extend({
  img: require('graphics/spell_natures_wrath2.png'),
  dim: [7.5, 7.5],
  imgBaseAngle: -45,
  sType: 'static',
  sId: 'naturesWrath',
  initialize: function () {
    ...
    this.hit = function () {
      this.duration = 120;
      ParticleSplatter(15, plantHit.bind(this));
...
SpellList.NaturesWrath = function (spellIndex) {
...
var NaturesWrathRocket = Spell.extend({
  img: require('graphics/spell_missile.png'),
  dim: [5,5],
  imgBaseAngle: 135,
  sType: 'projectile',
  ...
  removeEvent: function () {
    ...
    ParticleSplatter(12, explodeHit.bind(this));
  },
});
...
var explodeHit = function () {
  var randVel = new Coord([Math.random(), Math.random() * 1.5]).plusAngleDeg(Math.random() * 360);
...
export default SpellList.NaturesWrath;
