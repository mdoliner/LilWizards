...
var BerserkAilment = Ailment.extend({
  sType: 'misc',
  sId: 'berserk',
  duration: 300,
  initialize: function () {
    ...
    ParticleSplatter(40, startParticles.bind(this));
  },
  ...
  tickEvent: function () {
    if (this.victim.isDead()) {
      ...
      ParticleSplatter(2, tickParticles.bind(this));
    }
  },
  ...
  removeEvent: function () {
    ...
    var ending = setInterval(function () {
      ParticleSplatter(2, endParticles.bind(this));
...
SpellList.Berserk = function (spellIndex) {
...
var tickParticles = function () {
  var randVel = (new Coord(2)).times(Math.random()).plusAngleDeg(Math.random() * 360);
  return {
...
var startParticles = function () {
  var randVel = (new Coord(1.2)).plusAngleDeg(Math.random() * 360);
  return {
    pos: this.victim.pos.dup(),
    vel: randVel,
    game: this.game,
...
export default SpellList.Berserk;
