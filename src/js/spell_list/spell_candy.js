...
const EvilCandy = Spell.extend({
  ...
  removeEvent: function () {
    ...
    ParticleSplatter(40, splatterParticles.bind(this));
  },

});

SpellList.EvilCandy = function (spellIndex) {
...
var splatterParticles = function () {
  var randVel = new Coord([Math.random() * 5,Math.random() * 5]).plusAngleDeg(Math.random() * 360);
...
export default SpellList.EvilCandy;
