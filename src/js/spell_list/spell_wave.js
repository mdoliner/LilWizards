...
var WaveSpell = Spell.extend({
  vel: [0, 0],
  img: require('graphics/spell_wave.png'),
  imgBaseAngle: 270,
  dim: [20, 5],
  duration: 60,
  sType: 'melee',
  ...
  tickEvent: function () {
    ...
    if (action === 'release' || action === 'none') {
      ...
      ParticleSplatter(2, WaveParticles.bind(this));
    }
  },
...
SpellList.Wave = function (spellIndex) {
